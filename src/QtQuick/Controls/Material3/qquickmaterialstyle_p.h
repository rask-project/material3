...
class QQuickMaterialStyle : public QQuickAttachedPropertyPropagator
{
    ...
    Q_PROPERTY(QVariant primary READ primary WRITE setPrimary RESET resetPrimary NOTIFY
                       primaryChanged FINAL)
    Q_PROPERTY(QVariant accent READ accent WRITE setAccent RESET resetAccent NOTIFY accentChanged
                       FINAL)
    ...
    Q_PROPERTY(RoundedScale roundedScale READ roundedScale WRITE setRoundedScale RESET
                       resetRoundedScale NOTIFY roundedScaleChanged FINAL)
    Q_PROPERTY(ContainerStyle containerStyle READ containerStyle WRITE setContainerStyle RESET
                       resetContainerStyle NOTIFY containerStyleChanged FINAL)
    ...
    Q_PROPERTY(QColor primaryHighlightedTextColor READ primaryHighlightedTextColor NOTIFY
                       primaryHighlightedTextColorChanged FINAL)
    ...
    Q_PROPERTY(QColor highlightedRippleColor READ highlightedRippleColor NOTIFY themeOrAccentChanged
                       FINAL)
    Q_PROPERTY(QColor switchUncheckedTrackColor READ switchUncheckedTrackColor NOTIFY themeChanged
                       FINAL)
    Q_PROPERTY(QColor switchCheckedTrackColor READ switchCheckedTrackColor NOTIFY
                       themeOrAccentChanged FINAL)
    Q_PROPERTY(QColor switchUncheckedHandleColor READ switchUncheckedHandleColor NOTIFY themeChanged
                       FINAL)
    Q_PROPERTY(QColor switchUncheckedHoveredHandleColor READ switchUncheckedHoveredHandleColor
                       NOTIFY themeChanged FINAL)
    Q_PROPERTY(QColor switchDisabledUncheckedTrackColor READ switchDisabledUncheckedTrackColor
                       NOTIFY themeChanged FINAL)
    Q_PROPERTY(QColor switchDisabledCheckedTrackColor READ switchDisabledCheckedTrackColor NOTIFY
                       themeChanged FINAL)
    Q_PROPERTY(QColor switchDisabledUncheckedTrackBorderColor READ
                       switchDisabledUncheckedTrackBorderColor NOTIFY themeChanged FINAL)
    Q_PROPERTY(QColor switchCheckedHandleColor READ switchCheckedHandleColor NOTIFY
                       themeOrAccentChanged FINAL)
    Q_PROPERTY(QColor switchDisabledUncheckedHandleColor READ switchDisabledUncheckedHandleColor
                       NOTIFY themeChanged FINAL)
    Q_PROPERTY(QColor switchDisabledCheckedHandleColor READ switchDisabledCheckedHandleColor NOTIFY
                       themeChanged FINAL)
    Q_PROPERTY(QColor switchDisabledCheckedIconColor READ switchDisabledCheckedIconColor NOTIFY
                       themeChanged FINAL)
    Q_PROPERTY(QColor switchDisabledUncheckedIconColor READ switchDisabledUncheckedIconColor NOTIFY
                       themeChanged FINAL)
    ...
    Q_PROPERTY(QColor sliderDisabledColor READ sliderDisabledColor NOTIFY themeChanged FINAL
                       REVISION(2, 15))
    Q_PROPERTY(QColor textFieldFilledContainerColor READ textFieldFilledContainerColor NOTIFY
                       themeChanged FINAL)
    ...
    Q_PROPERTY(bool noEffects READ noEffects CONSTANT FINAL)
...
public:
    ...
    Q_INVOKABLE QColor shade(const QColor &color, qreal factor, Theme theme = Theme::Light) const;
